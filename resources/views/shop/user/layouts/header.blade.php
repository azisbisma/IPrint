                                    ...
                                    <div class="cart-items">
                                        ...
                                        <div class="shopping-item">
                                            ...
                                            <ul class="shopping-list">
                                                {{-- {{Helper::getAllProductFromCart()}} --}}
                                                    @foreach(Helper::getAllProductFromCart() as $cartItem)
                                                        <li>
                                                            <a href="" class="remove cart_delete" title="Remove this item" data-id="{{$cartItem->rowId}}"><i class="lni lni-close"></i></a>
                                                            ...
                                                            <div class="content">
                                                                ...
                                                                <p class="quantity">{{$cartItem->quantity}}x - <span class="amount">Rp{{number_format($cartItem->price)}}</span></p>
                                                            </div>
                                                        </li>
                                                    @endforeach
                                            </ul>
                                            <div class="bottom">
                                                <div class="total">
                                                    <span>Total :</span>
                                                    <span class="total-prc">Rp{{number_format(Helper::totalCartPrice())}}</span>
                                                </div>
                                                <div class="button">
